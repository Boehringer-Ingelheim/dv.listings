...
test_that("get_labels() returns column labels of a data.frame in a character vector, named according to the column names", {
...
test_that("get_labels() returns labels for each element of a list of data.frames in a character vector,
       named according to the data.frame names", {
...
test_that("generate_choices() generates meaningful choices for datasets and columns
       to be used in the corresponding dropdown menues", {
...
test_that("set_data() creates descriptive column names consisting of the column names of base_data
       and their labels appended in square brackets", {
